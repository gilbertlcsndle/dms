...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('officials', '0008_auto_20170407_1409'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='official',
            name='answer1',
            field=models.CharField(max_length=50, verbose_name='Answer'),
        ),
        migrations.AlterField(
            model_name='official',
            name='answer2',
